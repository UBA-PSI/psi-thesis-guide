...
\renewcommand*{\marginfont}{\scriptsize\sffamily\itshape} % format margin text
...
\geometry{
	...
	outer=5.8cm, % Outer margin, extra wide for margin notes
	marginparwidth=4cm,
	marginparsep=4mm,
...
%\ihead{\textsc{\headmark}}% Inner header - use this line for Small Caps in header
...
\DeclareCaptionStyle{sidecaption}{format=plain,font={scriptsize,sf,it},labelfont=bf,margin=0pt,singlelinecheck=true,justification=outerragged} 
\DeclareCaptionStyle{marginfigure}{format=plain,font={scriptsize,sf,it},labelfont=bf,margin=0pt,singlelinecheck=true}
\DeclareCaptionStyle{margintable}{format=plain,font={scriptsize,sf,it},labelfont=bf,margin=0pt,singlelinecheck=true}
\DeclareCaptionStyle{widefigure}{format=plain,font=small,labelfont=bf,justification=raggedright,singlelinecheck=true}
\DeclareCaptionStyle{widetable}{format=plain,font=small,labelfont=bf,justification=raggedright,singlelinecheck=true}
%\DeclareCaptionStyle{widefigure}{format=plain,justification=RaggedRight,font=small,labelfont=bf,margin=20pt,singlelinecheck=true,tableposition=top}

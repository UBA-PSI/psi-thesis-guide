...
\titleformat{\chapter}[hang]{\Huge\bfseries}{\color{gray75}\thechapter}{20pt}{\begin{tabular}[t]{@{\color{gray75}\vrule width 2pt\hsp}p{0.85\textwidth}}\raggedright\ReplaceStrQ{#1}\end{tabular}}

\titleformat{\section}[hang]{\bfseries\Large}{\arabic{chapter}.\arabic{section}}{1ex}{ \ReplaceStrQ{#1}}{}

\titleformat{\subsection}[hang]{\bfseries\large}{\arabic{chapter}.\arabic{section}.\arabic{subsection}}{1ex}{\ReplaceStrQ{#1}}{}

\titleformat{\subsubsection}[hang]{\bfseries}{\arabic{chapter}.\arabic{section}.\arabic{subsection}.\arabic{subsubsection}}{1ex}{\ReplaceStrQ{#1}}{}
...
\renewcommand{\marginnotevadjust}{0.63\baselineskip}
...
% make citations hyperlinks, grey
\usepackage{hyperref}
 \hypersetup{colorlinks,breaklinks,
             citecolor=[rgb]{0.3,0.3,0.3},

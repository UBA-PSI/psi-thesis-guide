...
Tables are using the more formal \emph{booktabs} style, which avoids all vertical lines. Horizontal lines should be used sparingly as well. You are encouraged to use bold print to highlight especially relevant parts. Also, you can make use of small amounts of vertical space to group rows together (as was done in Table~\ref{tab:treatments}).
...
Make sure to resize figures to an appropriate size.
...
Use \emph{title case} for your \emph{chapters}, \emph{sections}, and \emph{paragraphs}. Consider, for instance, \url{https://capitalizemytitle.com} for title case capitalization rules.

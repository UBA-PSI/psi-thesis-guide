...
There will hopefully be many figures in your thesis. Place them in the \emph{Figures} folder. Ideally, you draw all figures yourself to ensure that they use a \textbf{consistent graphical language} (such as line thickness, arrowheads, and shading).

Make sure that your figures work when \textbf{printed in monochrome}, i.\,e., do not rely on colors. If you use colors, use the same color palette in all figures, and ensure that readers with color blindness can differentiate all colors.

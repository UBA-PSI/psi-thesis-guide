...
Your first task is to decide whether a visualization makes sense at all. As Ware explains for the example of a flow chart of a program flow \cite{Ware12}, sometimes it makes sense to choose a text-only representation such as pseudo code.

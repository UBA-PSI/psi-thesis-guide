...
Line charts are primarily used to visualize time series. In principle, they are supposed to show how a variable (the one on the y-axis) changes when another one is varied within a given range. Figure~\ref{fig:linecharts}

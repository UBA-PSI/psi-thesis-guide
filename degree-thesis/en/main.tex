...
%
% Exception: Figures and tables that have been taken from the
% literature (denoted with a citation in the caption) are not
...
%
% Exception: Chapter 1 and Appendix C are based on content from the
...
\degree{Bachelor} % used in Declaration of Authorship (singular, German)
...
\def\tdate{\today}
% for the final version, insert the date of submission in the format "Month YYYY", e.g., January 2020
%\def\tdate{January 2020}

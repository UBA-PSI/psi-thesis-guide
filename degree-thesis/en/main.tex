...
% If your title does contain a Q, you might want to redundantly enter the title in setup.tex
% in the PDF METADATA section, because the swashed Q will mess up the title in the metadata.
\catcode`Q=\active
\defQ{\swashedletter}
...
% TODO - get rid of this poor hack:
% This is needed to have the correct APPENDIX prefix in the TOC for the APPENDICES.
% This line must be inserted *before* the \include line for the last ordinary chapter
